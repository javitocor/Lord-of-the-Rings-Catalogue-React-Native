    ...
    <ImageBackground source={require('../assets/images/background7.jpg')} resizeMode="cover" style={styles.bgimage}>
      <View style={styles.container}>
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.headerTextBottom}>{!props.route.params? 'MOVIES' : props.route.params.title.toUpperCase()}</Text>
        </View>
...
export default connect(mapStateToProps)(HeaderMovies);